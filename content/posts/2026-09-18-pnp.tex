...
be the one where AIs automate creativity, and quickly prove $P = NP$, via an $O(n^{100})$ time algorithm for \href{https://en.wikipedia.org/wiki/Boolean_satisfiability_problem}{SAT}.
