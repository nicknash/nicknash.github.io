...
\begin{abstract}
In Summer 2025, I looked for an easy graph algorithm to improve.
...
came up with all of the ideas in the paper in about two hours. I then considered
...
I would be able to publish the result of this tinkering in a peer-reviewed academic venue of some kind.

Long ago in I had done a (very) small bit of \href{https://researchrepository.ul.ie/server/api/core/bitstreams/12fd8a39-ae57-4f47-8301-1f5e231e78fc/content}{work} on graph algorithms, and so I looked for an algorithm there.
...
Given one of the input graphs on the left, the problem asks for the largest set of nodes (dots) that can be chosen such that the resulting graph (which includes all the edges connected to those nodes) has no cycles.
...
With that said, it is still stunning that \href{https://chatgpt.com/share/6a8434d4-c278-83ed-aeb1-f2f0cd1bdb62}{ChatGPT 5.6 Sol came up with} exactly the algorithmic improvements that were published in my paper,
...
I was as certain as anyone could be that this algorithm had never been published before.
